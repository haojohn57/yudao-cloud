...
public class DriverCustomServiceImpl implements DriverCustomService {
    ...
    private volatile Map<Long, ModbusMaster> masterMap = new HashMap<Long, ModbusMaster>(64);
     ...
     */
    public ModbusMaster getMaster(@NotNull Long deviceId, Map<String, AttributeInfo> driverInfo) throws ModbusInitException {
