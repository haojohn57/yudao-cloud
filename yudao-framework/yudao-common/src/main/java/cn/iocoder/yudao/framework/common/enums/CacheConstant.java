...
public interface CacheConstant {
     ...
     */
    interface Prefix {
        String REAL_TIME_VALUE_KEY_PREFIX = Entity.POINT + Suffix.VALUE + Symbol.SEPARATOR;
        String DRIVER_STATUS_KEY_PREFIX = Entity.DRIVER + Suffix.STATUS + Symbol.SEPARATOR;
        String DEVICE_STATUS_KEY_PREFIX = Entity.DEVICE + Suffix.STATUS + Symbol.SEPARATOR;
    }
