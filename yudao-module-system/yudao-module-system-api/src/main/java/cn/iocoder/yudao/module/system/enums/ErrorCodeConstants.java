...
public interface ErrorCodeConstants {
    ...
    // ========== 设备 1002023000 ==========
    ErrorCode DEVICE_NOT_EXISTS = new ErrorCode(1002023000, "设备不存在");
    ErrorCode DEVICE_NOT_ENABLE = new ErrorCode(1002023001, "设备被禁止");

    // ========== 协议驱动 1002024000 ==========
    ErrorCode DRIVER_NOT_EXISTS = new ErrorCode(1002024000, "协议驱动不存在");
    ErrorCode DRIVER_PORT_DUPLICATE = new ErrorCode(1002024001, "协议驱动端口已占用");
    ErrorCode DRIVER_INFO_NOT_EXISTS = new ErrorCode(1002024002, "协议驱动信息不存在");
    ErrorCode DRIVER_ATTRIBUTE_NOT_EXISTS = new ErrorCode(1002024003, "协议驱动属性不存在");
    ErrorCode DRIVER_ATTRIBUTE_USED_CANNOT_DELETED = new ErrorCode(1002024004, "协议属性被占用无法删除");
    ErrorCode DRIVER_NAME_BLANKED = new ErrorCode(1002024005, "协议名称空白");
    // ========== 设备模板 1002025000 ==========
    ErrorCode PROFILE_NOT_EXISTS = new ErrorCode(1002025000, "设备模板不存在");
    ErrorCode PROFILE_BIND_NOT_EXISTS = new ErrorCode(1002025001, "设备模板绑定不存在");

    ErrorCode PROFILE_NAME_BLANK = new ErrorCode(1002025002, "设备模板名称空白");
    // ========== 设备位号 1002026000 ==========
    ErrorCode POINT_NOT_EXISTS = new ErrorCode(1002026000, "设备位号不存在");
    ErrorCode POINT_INFO_NOT_EXISTS = new ErrorCode(1002026001, "设备位号信息不存在");
    ErrorCode POINT_ATTRIBUTE_NOT_EXISTS = new ErrorCode(1002026002, "设备位号属性不存在");
    ErrorCode POINT_ATTRIBUTE_USED_CANNOT_DELETED = new ErrorCode(1002026003, "设备位号属性被占用无法删除");
    ErrorCode POINT_EXCEDED_DEFAULT_MAX_REQUEST_SIZE = new ErrorCode(1002026004, "设备位号值大于了缺省最大值");
}
